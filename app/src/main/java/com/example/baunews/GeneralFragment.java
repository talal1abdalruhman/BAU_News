...
public class GeneralFragment extends Fragment {
    ...
    private void insertDataIntoCards() {
        ...
        cardsModel a = new cardsModel("News 1", "20/7/2021", appscovers[0], "Shawqi Radwan");
        cardsLists.add(a);

        a = new cardsModel("News 2", "20/7/2021", appscovers[0], "Shawqi Radwan");
        cardsLists.add(a);

        a = new cardsModel("News 3", "20/7/2021", appscovers[0], "Shawqi Radwan");
        cardsLists.add(a);

        a = new cardsModel("News 4", "20/7/2021", appscovers[0], "Shawqi Radwan");
        cardsLists.add(a);
